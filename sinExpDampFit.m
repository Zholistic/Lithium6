function [ outputCoefs, outputCoefError ] = sinExpDampFit( profileToFit, xs )
...
%Returns the co-efficients of the fit. 
    ...
    %For PCA/50Hz fits    
    p0 = [0.06 0.0044 0.2613 0.75 mean(profileToFit)];
    lb = [-3 0.0001 -1 -4 mean(profileToFit)-10];
    ub = [3  0.1 1 4 mean(profileToFit)+10]; %0.5 is ~ 80Hz
