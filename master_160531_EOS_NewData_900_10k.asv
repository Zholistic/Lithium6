directory = 'C:\Data\EOS_Data\160620_2d_eos_900G_10us_0p25_isat_1us_15isat_1000ms_laser_ramp_250ms_field_ramp_2s2devap_1p15v_10katoms\';
date = '160620';
camera = 'top';
varstring = 'Isat';
%varstring2 = 'Holdtime';
...
calcRegion = 3:45;
a0 = 5.29e-11; %o.0
a2dVectorOld = a0.*102339;
omegaRVector = 2.*pi.*25.38;
...
%EOSGenerateBulk(radProfilesIndvToEOS(1,:,1:200)./(kpixelLength^2),radProfilesIndvToEOS(2,:,1:200),calcRegion,omegaR,900,a2d,smoothOn,saveOn,savestring)
%EOSGenerateBulk(radProfilesIndvToEOS(1,:,1:200)./(kpixelLength^2),radProfilesIndvToEOS(2,:,1:200),calcRegion,omegaR,900,a2d,smoothOn,zeroOn,saveOn,savestring)
%single in bulk function:
%EOSGenerateBulk(radProfilesAvg(1,:,1)./(kpixelLength^2),radProfilesAvg(2,:,1),2:65,omegaR,900,a2d,smoothOn,saveOn,savestring)

calcRegion = 2:52;
omegaZ = 5650*2*pi;
%fitVirial(radProfilesAvg(1,:,1)./(kpixelLength^2), radProfilesAvg(2,:,1),calcRegion, omegaZ, omegaR, 900, a2d, smoothOn, zeroOn)
