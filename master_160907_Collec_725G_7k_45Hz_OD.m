directory = 'C:\Data\160912_CollectiveOsc_2D_725G_600mVp2p_45Hz_7kAtoms_13mixture_ODcorr\';
...
fitVirial(radProfilesAvg(1,:,1)./(kpixelLength^2), radProfilesAvg(2,:,1),calcRegion, omegaZ, omegaR, 725, a2d, smoothOn, zeroOn);
