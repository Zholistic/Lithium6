directory = 'C:\Data\161006_CollectiveOsc_2D_712G_10katom_125mvPtoP_45Hz_5Cycles_13mix_ODcorr\';
...
%OD correction: plot(radProfilesAvg(2,1:40,1),radProfilesAvg(1,1:40,1)./radProfilesAvg(1,1:40,2)); grid on;
%Checked OD correction? Yes
%mean(radProfilesAvg(1,10:20,2)./radProfilesAvg(1,10:20,1))
%mean(varData(26:end,5))./mean(varData(1:25,5)) = 1.79;
radProfilesAvg(1,:,1) = radProfilesAvg(1,:,1).*2.*1.79;
...
%fitVirial(radProfilesAvg(1,:,1)./(kpixelLength^2), radProfilesAvg(2,:,1),calcRegion, omegaZ, omegaR, 712, a2d, smoothOn, zeroOn,0,0);
