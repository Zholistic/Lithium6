directory = 'C:\Data\160504_CollectiveOscillations_2D_Green_modulation_165mvpp_832G_varyholdtime_41Hz\';
...
plot(motFets(1:21),widthsR(1:21),'.');
...
%------------ PCA Code ------------%
        ...
        imagesToReshape = imageArrayAvgs(:,:,1:end);
        ...
        %Mode 1:
        [gcoefsPCAmode1,gcoefsPCAerror1] = sinExpDampFitFreqGuess(Y01(:,1),motFets(1:end),0.26);
        ...
        subplot(2,2,2);
        plot(fgsineDamp(gcoefsPCAmode1,1:520)); hold on;
        plot(motFets(1:end),Y01(:,1),'.','color',[0 0 0]); 
        text(5,-0.34,['\omega = 2\pi \times ' num2str(freqPCAmode1,4) ' (' num2str(freqPCAmode1ErrorMin,4) ',' num2str(freqPCAmode1ErrorMax,4) ')']); 
        hold off;
        
        %Mode 2:
        [gcoefsPCAmode2,gcoefsPCAerror2] = sinExpDampFitFreqGuess(Y01(:,2),motFets(1:end),0.13);
        ...
        plot(motFets(1:end),Y01(:,2),'.','color',[0 0 0]);
