directory = 'C:\Data\160502_CollectiveOscillations2D_880G_RampTo900G\';
...
%------------ PCA Code ------------%
        ...
        imagesToReshape = imageArrayAvgs;
        ...
        %Mode 1:
        [gcoefsPCAmode1,gcoefsPCAerror1] = sinExpDampFitFreqGuess(Y01((2:end),1),motFets(2:end),0.26);
        ...
        subplot(2,2,2);
        plot(fgsineDamp(gcoefsPCAmode1,1:21)); hold on;
        plot(motFets(2:end),Y01(2:end,1),'.'); 
        text(2,-0.07,['\omega = 2\pi \times ' num2str(freqPCAmode1,4) ' (' num2str(freqPCAmode1ErrorMin,4) ',' num2str(freqPCAmode1ErrorMax,4) ')']); 
        hold off;
        
        %Mode 2:
        [gcoefsPCAmode2,gcoefsPCAerror2] = sinExpDampFitFreqGuess(Y01(:,2),motFets,0.13);
        ...
        subplot(2,2,4);        
        plot(fgsineDamp(gcoefsPCAmode2,1:21)); hold on;
        plot(motFets,Y01(:,2),'.');
        text(2,-0.6,['\omega = 2\pi \times ' num2str(freqPCAmode2,4) ' (' num2str(freqPCAmode2ErrorMin,4) ',' num2str(freqPCAmode2ErrorMax,4) ')']); 
        hold off;
