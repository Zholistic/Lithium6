directory = 'C:\Data\161003_CollectiveOsc_2D_725G_10katom_300mvPtoP_45Hz_5Cycles_13mix_ODcorr\';
...
fitVirial(radProfilesAvg(1,:,1)./(kpixelLength^2), radProfilesAvg(2,:,1),calcRegion, omegaZ, omegaR, 725, a2d, smoothOn, zeroOn, 0, 0);
