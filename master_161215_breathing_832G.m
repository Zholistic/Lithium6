directory = 'C:\Data\161215_CollectiveOsc_2D_832G_12katom_500mvPtoP_48Hz_10Cycles_noninter\';
...
%------------ PCA Code ------------%
        ...
        %Mode 1:
        [gcoefsPCAmode1,gcoefsPCAerror1] = sinExpDampFitFreqGuess(Y01(:,1),motFets(1:pcaEndPoint),0.3);
...
if(1)   
        %Mode 2:
        [gcoefsPCAmode2,gcoefsPCAerror2] = sinExpDampFitFreqGuess(Y01(1:pcaEndPoint,2),motFets(1:pcaEndPoint),0.3);
...
if(1)   
        %Mode 3:
        [gcoefsPCAmode3,gcoefsPCAerror3] = sinExpDampFitFreqGuess(Y01(1:pcaEndPoint,3),motFets(1:pcaEndPoint),0.3);
