directory = 'C:\Data\161004_CollectiveOsc_2D_735G_10katom_350mvPtoP_46Hz_5Cycles_13mix_odcrr\';
...
%mean(radProfilesAvg(1,10:20,2)./radProfilesAvg(1,10:20,1)) = 1.56;
%mean(varData(26:end,5))./mean(varData(1:25,5)) = 1.907;
radProfilesAvg(1,:,1) = radProfilesAvg(1,:,1).*2.*1.56;
