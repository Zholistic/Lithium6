...
text(20,29,['\omega = 2\pi \times ' num2str(freqWidthsRFit1,4) ' (' num2str(freqWidthsRFit1Min,4) ',' num2str(freqWidthsRFit1Max,4) ')']);
...
%------------ PCA Code ------------%
        ...
        %Mode 1:
        [gcoefsPCAmode1,gcoefsPCAerror1] = sinExpDampFitFreqGuess(Y01(:,1),motFets(1:pcaEndPoint),0.24);
