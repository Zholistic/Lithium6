directory = 'C:\Data\140907_crossover_850G_Isat0p35_10usPulse_freq5kHz_insitu\';
date = '140907';
camera = 'top';
varstring = 'motfet';
%varstring2 = 'Holdtime';
...
figure(14);
plot(log10(pixelNumbers),log10(widthsPsm),'MarkerSize',3,...
    'MarkerFaceColor',[0.600000023841858 0.600000023841858 1],...
    'Marker','o',...
    'LineStyle','--',...
    'Color',[0 0 1]);
...
figure(15);
plot(pixelNumbers,widthsPsm./(pixelNumbers.^0.25),'MarkerSize',3,...
    'MarkerFaceColor',[0.600000023841858 0.600000023841858 1],...
    'Marker','o',...
    'LineStyle','--',...
    'Color',[0 0 1]);
...
figure(17);
plot(pixelNumbers,widthsPsm./(pixelNumbers.^0.21),'MarkerFaceColor',[0.600000023841858 0.600000023841858 1],...
    'Marker','o',...
    'LineStyle','none',...
    'Color',[0 0 1]);
grid on;
