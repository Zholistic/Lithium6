directory = 'C:\Data\140912_2d_transverse_crossover_855G_750ms_laser_ramp_ISAT1e6_alpha_1\';
date = '140912';
camera = 'sidecam';
varstring = 'motfet';
magfield = '855G';
...
%csvwrite(['C:\Data\ElbowProfile_855' num2str(binnum) '.csv'],mean(avgImagesBin(CrossROIy,:,binnum),1));
end
