directory = 'C:\Data\161219_CollectiveOsc_2D_680G_7katom_75mvPtoP_45Hz_5Cycles_13mix\';
...
%------------ PCA Code ------------%
        ...
        %Mode 1:
        [gcoefsPCAmode1,gcoefsPCAerror1] = sinExpDampFitFreqGuess(Y01(:,1),motFets(1:pcaEndPoint),0.31);
...
if(1)   
        %Mode 2:
        [gcoefsPCAmode2,gcoefsPCAerror2] = sinExpDampFitFreqGuess(Y01(1:pcaEndPoint,2),motFets(1:pcaEndPoint),0.31);
