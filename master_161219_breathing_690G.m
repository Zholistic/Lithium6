directory = 'C:\Data\161219_CollectiveOsc_2D_690G_7katom_50mvPtoP_46Hz_5Cycles_13mix\';
...
if(0)
    fitToPoint = 36;
[gcoefswidthsRfit1,gcoefswidthsRfit1error] = sinExpDampFitFreqGuess(widthsR(1:fitToPoint),motFets(1:fitToPoint),0.32);
...
%------------ PCA Code ------------%
        ...
        %Mode 1:
        [gcoefsPCAmode1,gcoefsPCAerror1] = sinExpDampFitFreqGuess(Y01(:,1),motFets(1:pcaEndPoint),0.30);
...
if(1)   
        %Mode 2:
        [gcoefsPCAmode2,gcoefsPCAerror2] = sinExpDampFitFreqGuess(Y01(1:pcaEndPoint,2),motFets(1:pcaEndPoint),0.30);
...
if(1)   
        %Mode 3:
        [gcoefsPCAmode3,gcoefsPCAerror3] = sinExpDampFitFreqGuess(Y01(1:pcaEndPoint,3),motFets(1:pcaEndPoint),0.30);
