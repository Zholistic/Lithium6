directory = 'C:\Data\161215_CollectiveOsc_2D_832G_12katom_500mvPtoP_48Hz_10Cycles_noninter_ODcrr\';
...
%mean(radProfilesAvg(1,10:20,2)./radProfilesAvg(1,10:20,1)) = 1.25
%mean(varData(26:end,5))./mean(varData(1:25,5)) = 1.37;
radProfilesAvg(1,:,1) = radProfilesAvg(1,:,1).*2.*1.25;
...
%fitVirial(radProfilesAvg(1,:,1)./(kpixelLength^2), radProfilesAvg(2,:,1),calcRegion, omegaZ, omegaR, 750, a2d, smoothOn, zeroOn,0,0);
